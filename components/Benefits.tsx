...
const benefits: Benefit[] = [
  {
    ...
    description:
      'Быстрое развертывание решений благодаря готовым модулям и облачной инфраструктуре',
  ...
  },
  {
    ...
    description:
      'Сокращение операционных расходов до 70% за счет автоматизации рутинных процессов',
  ...
  },
  {
    ...
    description:
      'Легкое масштабирование решений под растущие потребности бизнеса без потери качества',
  ...
  },
  {
    ...
    title: 'Безопасность',
    description:
      'Сертифицированные решения с шифрованием данных и соответствием международным стандартам',
  ...
  },
  {
    ...
    title: 'Интеллект',
    description:
      'Самообучающиеся системы, которые постоянно улучшают качество работы и точность',
  ...
  },
  {
    ...
    title: 'Доступность',
    description:
      'Круглосуточная работа систем из любой точки мира с любым устройством',
...
export default function Benefits() {
  return (
    <section
      id="benefits"
      className="py-20 bg-gray-50 scroll-mt-24 md:scroll-mt-28"
    >
