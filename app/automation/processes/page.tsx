...
export default function ProcessAutomationPage() {
  const cases: CaseItem[] = [
    {
      ...
      description:
        'ИИ-система для автоматической обработки входящих документов, классификации и маршрутизации',
      benefits: [
    ...
    },
    {
      ...
      description:
        'Полный цикл автоматизации от приема заказа до отгрузки и уведомления клиента',
      benefits: [
        'Круглосуточная обработка',
        'Интеграция с CRM и ERP',
        'Автоуведомления клиентов',
      ],
      image: '🛒',
    ...
    },
    {
      ...
      description:
        'Автоматическое проведение платежей, сверка счетов и формирование отчетности',
      benefits: [
        'Исключение человеческого фактора',
        'Мгновенное проведение операций',
        'Автоформирование отчетов',
      ],
      image: '💳',
    ...
    },
    {
      ...
      description:
        'Оптимизация складских процессов, прогнозирование спроса и автоматическое управление запасами',
    ...
    },
    {
      ...
      description:
        'Автоматизация подбора кандидатов, обработки резюме и onboarding процесса',
      benefits: [
        'Анализ 1000+ резюме/час',
        'Автосортировка кандидатов',
    ...
    },
    {
      ...
      description:
        'Полная автоматизация обработки обращений и запросов клиентов без участия человека',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12 scroll-mt-24 md:scroll-mt-28">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {cases.map((caseItem, index) => (
            ...
            >
              ...
              {/* Description */}
              <p className="text-gray-600 mb-4 text-center">{caseItem.description}</p>
              ...
              <div className="bg-gray-50 rounded-lg p-3">
                ...
                <div className="grid grid-cols-1 gap-1">
                  {caseItem.stats.map((stat) => (
                    <div key={stat} className="text-xs text-gray-600 font-medium">
                      ✅ {stat}
                    </div>
                  ))}
                </div>
        ...
        >
          ...
          <Link
            href="/#contacts"
            className="inline-block bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:shadow-xl transition-all"
          >
            Обсудить проект
          </Link>
        </motion.div>
